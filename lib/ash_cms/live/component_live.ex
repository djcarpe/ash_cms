defmodule AshCms.Live.ComponentLive do
  ...
  def render(assigns) do
    ...
    <div style="display: flex; flex-direction: column; height: 100vh; overflow: hidden;">
      <div style="padding: 16px 24px; border-bottom: 1px solid var(--ash-cms-border); display: flex; gap: 12px; align-items: center;">
      ...
      <div style="display: flex; flex: 1; overflow: hidden;">
        <%!-- Left: metadata form --%>
        <form phx-submit="save" style="width: 280px; padding: 20px; border-right: 1px solid var(--ash-cms-border); overflow-y: auto; display: flex; flex-direction: column; gap: 14px; flex-shrink: 0;">
          <div>
          ...
          <div>
            <label style="font-size: 0.75rem; font-weight: 500; color: var(--ash-cms-text-muted); display: block; margin-bottom: 4px;">Category</label>
          ...
          <div>
            <label style="font-size: 0.75rem; font-weight: 500; color: var(--ash-cms-text-muted); display: block; margin-bottom: 4px;">Description</label>
            <textarea name="component[description]" rows="2"
                      style="width: 100%; padding: 7px; border: 1px solid var(--ash-cms-border); border-radius: 6px; box-sizing: border-box;"><%= Map.get(@component, :description) || "" %></textarea>
          </div>

          <button type="submit" style="padding: 9px 16px; background: var(--ash-cms-primary); color: var(--ash-cms-on-accent); border: none; border-radius: 6px; cursor: pointer; font-weight: 600;">
            Save Component
          </button>
        </form>
        ...
        <div style="flex: 1; display: flex; flex-direction: column; overflow: hidden;">
          <div style="padding: 8px 16px; background: var(--ash-cms-surface); border-bottom: 1px solid var(--ash-cms-border); font-size: 0.8125rem; color: var(--ash-cms-text-muted); font-weight: 500;">
        ...
        <%!-- Right: preview --%>
        <div style="width: 360px; border-left: 1px solid var(--ash-cms-border); display: flex; flex-direction: column; flex-shrink: 0;">
          <div style="padding: 8px 16px; background: var(--ash-cms-surface); border-bottom: 1px solid var(--ash-cms-border); font-size: 0.8125rem; color: var(--ash-cms-text-muted); font-weight: 500;">
