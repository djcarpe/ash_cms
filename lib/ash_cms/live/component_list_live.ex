  ...
  def render(assigns) do
    ...
    <div style="padding: 24px; max-width: 1000px; margin: 0 auto;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <div>
          <a href={"/cms/sites/#{@site_id}/pages"} style="color: var(--ash-cms-text-muted); text-decoration: none; font-size: 0.875rem;">← Pages</a>
      ...
      <%= if Enum.empty?(@components) do %>
        <div style="text-align: center; padding: 48px; color: var(--ash-cms-text-muted);">
      ...
      <% else %>
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 16px;">
          <%= for comp <- @components do %>
            <div style="border: 1px solid var(--ash-cms-border); border-radius: 8px; padding: 16px; background: var(--ash-cms-bg);">
              ...
              <p style="margin: 0 0 12px; color: var(--ash-cms-text-muted); font-size: 0.8125rem;"><%= comp.description %></p>
